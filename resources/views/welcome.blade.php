                ...
                <div
                    ...
                    <div class="lg:pr-8 lg:pt-4">
                        <div class="lg:max-w-lg">
                            <h2 class="text-base font-semibold leading-7 text-indigo-500">Deploy faster</h2>
                            <p
                                class="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl">
                                A better
                                workflow</p>
                            <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">Lorem ipsum, dolor sit
                                amet consectetur
